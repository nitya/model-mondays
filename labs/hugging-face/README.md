...
This folder will collect demos and tutorials showcased in Model Mondays that reflect usage of Hugging Face Models with Microsoft Foundry, Visual Studio Code, or Foundry Local environments.

---

## S2:E13 Spotlight: Jeff Boudier (VP @Hugging Face)

As of Sep 15, 2025 - the Microsoft Foundry Models catalog has over 10K open-source models in its [Hugging Face Collection](https://ai.azure.com/catalog/publishers/hugging%20face,huggingface)! But how can you get started _discovering_, _deploying_ and _using_ these models to build intelligent apps?
...
1. [Visit Hugging Face on Microsoft Foundry](https://ai.azure.com/catalog/publishers/hugging%20face,huggingface) - to explore the 10K+ models 
