...
> Model Mondays is a weekly series to build your Microsoft Foundry Model IQ. In this episode, we focus on the Model Context Protocol (MCP) — and learn how to securely connect AI models to real-world tools and services using MCP, Microsoft Foundry, and industry-standard authorization.

_This week in Model Mondays, we focus on the Model Context Protocol (MCP) — and learn how to securely connect AI models to real-world tools and services using MCP, Microsoft Foundry, and industry-standard authorization. Read on for my recap_
...
![MCP](./../../assets/model-mondays/S2-E2.png)
...
Want to learn more about MCP - check out the AI Engineer World Fair 2025 "MCP and Keynotes" track. It kicks off with a keynote from Asha Sharma that gives you a broader vision for Microsoft Foundry. Then look for the talk from Harald Kirschner on MCP and VS Code.
...
![MCP](./../../assets/model-mondays/S2-E3.png)
