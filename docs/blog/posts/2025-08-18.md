...
Want to get a quick hands-on demo of this technology? Check out a new series called [Inside Azure AI Foundry](https://aka.ms/insideAIF) that will feature key news items or spotlight technologies in short easy-to-watch demos with code. Check out the [Inside Azure AI Foundry: Mistral Document AI](https://www.youtube.com/watch?v=MUu9o8tDwi0&list=PLlrxD0HtieHj61bBwrAqd5yHvwjB8s_oz&index=1&pp=iAQB) today!
...
![S2E11 Banner](../../../data/assets/livestream/S2-E11.png)

Next week: Azure AI Foundry Speech Playground!  
