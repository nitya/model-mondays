...
- [**Agent Factory Blog Series:**](https://azure.microsoft.com/blog/tag/agent-factory/)  
  A new 6-part blog series on designing reliable, agentic AI—exploring multi-step, collaborative agents that reflect, plan, and adapt using tool integrations and design patterns. 
- [**Text PII Preview in Azure AI Language:**](https://techcommunity.microsoft.com/blog/azure-ai-foundry-blog/announcing-the-text-pii-august-preview-model-release-in-azure-ai-language/4441705)  
  Now redacts PII (like date of birth, license plates) in major European languages, with better accuracy for UK bank entities.
- [**Claude Opus 4.1 in Copilot Pro & Enterprise:**](https://github.blog/changelog/2025-08-05-anthropic-claude-opus-4-1-is-now-in-public-preview-in-github-copilot/)  
  Public preview brings smarter summaries, tool assistant thinking, and "Ask Mode" in VS Code.
- [**Azure Document Intelligence Upgrade:**](https://techcommunity.microsoft.com/blog/azure-ai-foundry-blog/unveiling-the-next-generation-of-table-structure-recognition/4443684) 
...
- [**Mistral Document AI in Azure Foundry:**](https://techcommunity.microsoft.com/blog/aiplatformblog/deepening-our-partnership-with-mistral-ai-on-azure-ai-foundry/4434656)  
...
- **Mistral Document AI:**  
  ...
  - Integrates seamlessly with Microsoft Foundry and developer workflows.
...
**NEW SERIES: INSIDE AZURE AI FOUNDRY**

Want to get a quick hands-on demo of this technology? Check out a new series called [Inside Microsoft Foundry](https://aka.ms/insideAIF) that will feature key news items or spotlight technologies in short easy-to-watch demos with code. Check out the [Inside Microsoft Foundry: Mistral Document AI](https://www.youtube.com/watch?v=MUu9o8tDwi0&list=PLlrxD0HtieHj61bBwrAqd5yHvwjB8s_oz&index=1&pp=iAQB) today!
...
Next week: Microsoft Foundry Speech Playground!  
