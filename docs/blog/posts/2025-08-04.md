...
2. **Seamless Integration With Existing Workflows** - Foundry Local provides an intuitive [CLI, SDK, and REST API](https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/), with easy scaling from local development to Microsoft Foundry (cloud) as needed.
...
---
## Coming Up Next Week:
![S2E09 Models for AI Agents](../../assets/model-mondays/S2-E9.png)

Want to build agentic AI applications but looking for resources to learn configuration and design patterns? Join us as we talk to Mona Whalin about the Microsoft Foundry Agent Catalog – open-source samples you can explore to accelerate your agent development by integration into projects!
