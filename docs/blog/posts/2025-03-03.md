...
![Model Mondays](./../../assets/misc/model-mondays-banner.png)
...
- The [Microsoft Foundry model catalog](https://ai.azure.com/explore/models) gives us 1800+ model options.
