...
![](./../../assets/model-mondays/S2-E1.png)
...
1. [Try the Microsoft Foundry model catalog](https://ai.azure/com/explore/models) and look for reasoning models by name. Example:
...
![AMA](./../../assets/foundry-fridays/S2-E1-AMA.png)
...
Here’s what’s new in the Microsoft Foundry:
...
Try it out in **Microsoft Foundry** or read more in the [Model Catalog](https://ai.azure.com/explore/models).
...
![Ep 2](./../../assets/model-mondays/S2-E2.png)
