...
> Model Mondays is a weekly series to build your Microsoft Foundry Model IQ. In this episode, we focus on the AI Developer Experience—streamlining the journey from model selection to deployment using the AI Toolkit and Microsoft Foundry extensions for Visual Studio Code.
...
AI Developer Experiences are all about making the process of building, testing, and deploying AI models as smooth as possible. With the right tools—like the AI Toolkit and Microsoft Foundry extensions for VS Code—developers can focus on innovation instead of setup hassles. This is crucial for accelerating the adoption of generative AI in real-world applications.
 
### 2. What is one key takeaway from the episode?
 
The integration of Microsoft Foundry with VS Code means you can manage models, run experiments, and deploy apps—all from your favorite editor. This unified workflow saves time and reduces friction for developers.
 
### 3. How can I get started?
 
- Install the [AI Toolkit for VS Code](https://marketplace.visualstudio.com/items?itemName=ms-ai-foundry.ai-toolkit)
- Explore the [Microsoft Foundry documentation](https://learn.microsoft.com/en-us/azure/developer/azure-ai-foundry/overview)
- Try out the sample projects and experiment with deploying your own models
 
### 4. What's new in Microsoft Foundry?
 
 
Here are some of the latest updates in Microsoft Foundry:
...
![Next](../../assets/model-mondays/S2-E5.png)
