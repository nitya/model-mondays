---
title: Foundry Friday AMA · Jun 30, 2025 · Model Context Protocol
description: Join us for an AMA on Model Context Protocol (MCP) with Den Delimarsky.
tags: [AMA, Model Context Protocol, Model Mondays]
---
